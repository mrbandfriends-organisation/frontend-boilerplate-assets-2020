...
(function($, window, document) {
    ...
    AccessibleMegaMenu.prototype = (function() {
        ...
        _keyDownHandler = function(event) {
            var that = this.constructor === AccessibleMegaMenu
                ? this
            ...
            switch (keycode) {
                ...
                default:
                    ...
                    keydownSearchString += newString !== keydownSearchString
                        ? newString
                        : '';
                    ...
                    for (i = 0; i < tabbables.length; i++) {
                        o = tabbables.eq(i);
                        if (o.is(target)) {
                            start = keydownSearchString.length === 1
                                ? i + 1
                                : i;
                            break;
                        }
